...
class MyWindow(QMainWindow,form_class):
    ...
    def exe(self):
        ...
        timerCallback2 = functools.partial(self.BB_TS, market="Gold")
    ...
    def R_est(self,market):
        ...
        # 매도 청산
            ...
            and self.Market[0]==market \
            and self.Margin>0:
            self.kiwoom.SendOrder("SendOrder_req3", "1103", "5057928272", 1, self.OrderCode, self.ClearLots2, "0", "0", "1", "0")
            self.Market[0]='Nothing'
            self.Position[0]='Nothing'
    ...
    def Target_limit(self, market):
        ...
        if self.Margin > 0  \
            ...
            self.fw = open('C:\\Users\dabee\Desktop\history.txt', 'a+')
            self.fw.write(market + '_' + "Target_Limit" + "_" + "Long Position Clear" + "_" + self.time_msg)
            self.fw.write('\n')
            self.fw.close()
            ...
            self.fw = open('C:\\Users\dabee\Desktop\history.txt', 'a+')
            self.fw.write(market + '_' + "Target_Limit" + "_" + "Short Position Clear" + "_" + self.time_msg)
            self.fw.write('\n')
            self.fw.close()
            ...
            self.fw2 = open('C:\\Users\dabee\Desktop\history2.txt', 'a+')
            self.fw2.write(market + '_' + str(self.Margin) + '_' + 'Target_Limit Processing' + '_' + self.time_msg)
            self.fw2.write('\n')
    ...
    def Corr(self,*args):
        ...
        for MarketName, MarketCode in  self.Market.items():
            ...
            # 보조지표
            self.kiwoom.MA(Data1, 5, 200, 600)
