...
class MyWindow(QMainWindow, form_class):
    ...
    def Target_limit(self, market):
        ...
        if self.Margin > 0  \
            ...
            self.kiwoom.SendOrder("SendOrder_req", "1101", "7002264172", 1, self.OrderCode, self.ClearLots1, "0", "0",
                                  "1", "0")  # 1:신규매도, 2:신규매수
            ...
            and c > self.doubleSpinBox_2.value():
            self.kiwoom.SendOrder("SendOrder_req1", "1102", "7002264172", 2, self.OrderCode, self.ClearLots2, "0", "0",
                                  "1", "0")  # 1:신규매도, 2:신규매수
    ...
    def Risk_limit(self, market):
        ...
        if self.Margin > 0 \
            ...
            if self.comboBox_2.currentText() == 'Long':
                self.kiwoom.SendOrder("SendOrder_req", "1101", "7002264172", 1, self.OrderCode, self.ClearLots1, "0",
                                      "0","1", "0")  # 1:신규매도, 2:신규매수

            elif self.comboBox_2.currentText() ==  'Short':
                self.kiwoom.SendOrder("SendOrder_req1", "1102", "7002264172", 2, self.OrderCode, self.ClearLots2, "0",
                                      "0", "1", "0")  # 1:신규매도, 2:신규매수
        ...
        if self.Margin > 0 \
           and c<ema200:
            if self.comboBox_2.currentText() == 'Long':
                ...
                self.kiwoom.SendOrder("SendOrder_req1", "1102", "7002264172", 2, self.OrderCode, self.ClearLots2, "0", "0", "1", "0")  # 1:신규매도, 2:신규매수
